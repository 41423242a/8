...
# 加入幻燈片
presentation.add_slide(title="第8組報告", background=bg_image)
presentation.add_slide(title="什麼是 Git？", background=bg_image)("分散式版本控制系統", background=bg_image)("可追蹤檔案變化", background=bg_image)("協作工具", background=bg_image)
